...
#include <cJSON.h>
#include <rtthread.h>
#include "xiaozhi_local_config.h"
...
#define GET_URI                 "http://%s:8000/xiaozhi/ota/"
#ifndef XIAOZHI_HOST
#define XIAOZHI_HOST            "192.168.10.132"
#endif
#define XIAOZHI_HOST_LEN        64
#ifndef XIAOZHI_DISCOVERY_PORT
#define XIAOZHI_DISCOVERY_PORT  58123
#endif
#ifndef XIAOZHI_DISCOVERY_REQUEST
#define XIAOZHI_DISCOVERY_REQUEST "XIAOZHI_DISCOVER_V1"
#endif
#ifndef XIAOZHI_DISCOVERY_RESPONSE
#define XIAOZHI_DISCOVERY_RESPONSE "XIAOZHI_CLOUD_V1"
#endif
#ifndef XIAOZHI_WS_PORT
#define XIAOZHI_WS_PORT         8000
#endif
#ifndef XIAOZHI_WS_SSL_ENABLED
#define XIAOZHI_WS_SSL_ENABLED  0
#endif
#ifndef XIAOZHI_WSPATH
#define XIAOZHI_WSPATH          "/xiaozhi/v1/"
#endif
#ifndef XIAOZHI_TOKEN
#define XIAOZHI_TOKEN           "12345678"
#endif
...
/* Meow detection control (implemented in meow_detect_once.cpp) */
int meow_detect_start(void);
int meow_detect_stop(void);
/* Notify the cloud of the current meow-detection on/off state (board1 -> cloud
 * sync when the user toggles meow mode on the device UI). */
void xz_notify_meow_state(rt_bool_t enabled);
/* Called once for every locally detected meow. Implemented in xiaozhi.cpp. */
void meow_water_on_meow(void);
